...
fn save_file() {
    ...
    let save_info = unsafe { &mut *addr_of_mut!(SAVE_INFO) };
...
impl super::Menu for ActionMenu {
    fn enable() {
        let action_menu = unsafe { &mut *addr_of_mut!(ACTION_MENU) };
    ...
    fn input() {
        ...
        const WARP_TO_START: u32 = 0;
        const SAVE_FILE: u32 = 1;
        const LOAD_FILE: u32 = 2;
        const LOAD_FILE_DIRECT: u32 = 3;
        const GIVE_ITEM: u32 = 4;
        const KILL_LINK: u32 = 5;
